...
public interface IPostService
{
    ...
    /// <summary>
    /// Obtener todos los posts con un zip en común
    /// </summary>
    /// <param name="postZipCode">Id del post a eliminar</param>
    Task<IEnumerable<Post>> ListByZipCodeAsync(string postZipCode);
}